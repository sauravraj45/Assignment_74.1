...
export default function ChatWindow() {
  const { messages, isLoading, error, toggleOpen, sendMessage, retry, clearChat, newChat } =
    useChat();
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 24px 60px -12px rgba(34,22,63,0.35), 0 8px 24px -8px rgba(255,159,28,0.18)',
    ...
    >
      <ChatHeader onClose={() => toggleOpen(false)} onNewChat={newChat} onClearChat={clearChat} />
