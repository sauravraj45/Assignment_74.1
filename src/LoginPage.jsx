        ...
        <div className='flex flex-col mt-10 mb-10'>
            <form onSubmit={handleSubmit} className='flex flex-col  gap-3 bg-white p-10 rounded-lg m-auto'>
                 ...
                 <div className='space-y-3 m-5'>
                        ...
                        <p className=' text-xl text-bg-300 text-center'>Enter your credential to login</p>
                </div>
                ...
                <div className='flex flex-col space-y-3'>
                   ...
                   <p className='text-blue-500 text-center self-end'><Link to={"/forgotpassword"} >Forgot Password?</Link></p>
                     <p>
